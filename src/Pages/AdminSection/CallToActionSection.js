                                    ...
                                    <>
                                        {
                                            ...
                                            action.map(c =>
                                                <Link className='btn btn-danger' to={`/edit-call/${c._id}`}> Edit Call To Action</Link>)
                                    ...
                                    <form class="contact-form " onSubmit={handleActionSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn mb-3">
                                                <button class="btn btn-danger" data-animation="fadeInRight" data-delay=".8s">Add Call To Action</button>
                                            </div>
                                        </div>
