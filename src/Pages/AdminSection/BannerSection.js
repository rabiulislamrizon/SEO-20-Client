                                    ...
                                    <>
                                        {
                                            banner.map(c =>
                                                banner.map(c =>
                                                    <Link className='btn btn-danger' to={`/banner/${c._id}`}> Edit Banner Section</Link>)
                                            )
                                        }
                                    </>
                                }
                                {
                                    ...
                                    <form class="contact-form " onSubmit={handleBannerSection}>
                                        <div class="row">
                                            ...
                                            <div >
                                                <button class="btn btn-danger" data-animation="fadeInRight" data-delay=".8s">Add Banner</button>
                                            </div>
                                        </div>
