...
const AddUser = () => {
    ...
    return (
        ...
        <HeaderBottom></HeaderBottom>
            ...
            <section id="services" class="services-area  vh-100 mt-5" >
                <div class="container">
                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                            ...
                                            {users.map(a =>
                                                <Link className='btn btn-danger' to={`/admin-user/${a._id}`}> Update User</Link>)}
                                ...
                                <form class="contact-form " onSubmit={handleUser}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn ">
                                            <button class="btn btn-danger" data-animation="fadeInRight" data-delay=".8s"> Add User </button>
