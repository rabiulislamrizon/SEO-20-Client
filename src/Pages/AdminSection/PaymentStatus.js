    ...
    return (
        <>
            ...
            <div className='container'>
                <section id="services" class="services-area  pb-90 fix mb-5 mt-5 vh-100">
                    <div class="container">
                        <div class="row"></div>
                            ...
                            <div className='text-center'> {/* Center-align the content */}
                                ...
                                <form onSubmit={handlePaymentStatus} className="text-center"> {/* Center-align the form */}
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-danger mt-2" data-animation="fadeInRight" data-delay=".8s"> Update Payment </button>
                                    </div>
                                </form>
                                ...
                                <form onSubmit={handleOrderStatus} className="text-center"> {/* Center-align the form */}
                                    ...
                                    <div class="slider-btn">
                                        <button class="btn btn-danger mt-2" data-animation="fadeInRight" data-delay=".8s"> Update Order </button>
                                    </div>
                                </form>
